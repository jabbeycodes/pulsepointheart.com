...
export function buildClinicJsonLd() {
  return {
    ...
    description:
      'PulsePoint Clinic is a physician-led cardiology clinic in Columbia, Missouri focused on prevention, advanced cardiovascular diagnostics, and personalized heart care.',
    address: {
      '@type': 'PostalAddress',
      ...CLINIC.address,
    },
